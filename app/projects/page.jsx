  ...
  return (
    <>
      <div className="bg-gray-50 min-h-screen py-12">
        ...
        <h1 className="text-3xl font-bold text-center my-12 text-blue-600">
            ...
            {timelineData.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* باکس محتوا */}
                  <div
                    className={`relative w-full md:w-5/12 p-5 bg-white rounded-xl shadow-md hover:shadow-lg transition ${isLeft ? "md:mr-auto" : "md:ml-auto"
                      }`}
                  >
